                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <a class="mb-4 btn btn-primary" href="{{ route('users.create') }}">Create User</a>
                                        ...
                                        <table class="table table-bordered dataTable" id="dataTable" width="100%"
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="odd">
                                                    ...
                                                    <td><form action="{{ route('users.destroy', $user->id) }}" method="POST" style="display:inline;">
                                                        @csrf
                                                        @method('DELETE')
