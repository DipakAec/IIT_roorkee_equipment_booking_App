                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <a class="mb-4 btn btn-primary" href="{{ route('roles.create') }}">Create Role</a>
                                        ...
                                        <table class="table table-bordered dataTable" id="dataTable" width="100%"
                                            ...
                                            <tbody>
                                                @foreach ($all_equipments as $role)
                                                <tr class="odd">
                                                    <td class="sorting_1">{{ $role->id }}</td>
                                                    <td>{{ $role->name }}</td>
                                                    <td> <a href="{{ route('roles.edit', $role->id) }}">Edit</a></td>
                                                    <td><form action="{{ route('roles.destroy', $role->id) }}" method="POST" style="display:inline;">
                                                        @csrf
                                                        @method('DELETE')
